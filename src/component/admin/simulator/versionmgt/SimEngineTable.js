  ...
  return (
    <section style={{fontSize: 20}}>
      <Menu onClick={handleClick} style={{fontSize: 16}} selectedKeys={current} mode="horizontal">
        <Menu.Item key="MCPSIM" icon={<AppstoreOutlined />}>
          MCPSIM
        </Menu.Item>
        <Menu.Item key="OCS4SIM" icon={<AppstoreOutlined />}>
          OCS4SIM
        </Menu.Item>
        <Menu.Item key="OCS3SIM" icon={<AppstoreOutlined />}>
          OCS3SIM
        </Menu.Item>
        <Menu.Item key="SeeFlow" icon={<AppstoreOutlined />}>
          SeeFlow
        </Menu.Item>
        <Menu.Item key="RemoteSim" icon={<AppstoreOutlined />}>
          RemoteSim
        </Menu.Item>
